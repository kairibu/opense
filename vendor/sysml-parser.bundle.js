// ---------------------------------------------------------------------------
// Browser bundle of the sysml-parser library (generated artifact).
// Source: /home/kai/Projekte/sandbox/sysml-parser/src/index.ts (sysml-parser repo; loader-fs.ts loadModelFromDirectory
//         is deliberately excluded as node-only).
// Chevrotain: 10.5.0 (bundled).
// Regenerate: npm run build:browser (in the sysml-parser repo).
// Do not edit by hand.
// ---------------------------------------------------------------------------
        ...
        BaseRegExpVisitor.prototype.visitChildren = function(node) {
          for (var key in node) {
            ...
            if (node.hasOwnProperty(key)) {
              if (child2.type !== void 0) {
                this.visit(child2);
              } else if (Array.isArray(child2)) {
                child2.forEach(function(subChild) {
                  this.visit(subChild);
                }, this);
              }
            }
  ...
  "node_modules/chevrotain/lib/src/scan/lexer_public.js"(exports2) {
    ...
    var Lexer2 = (
      ...
      (function() {
        ...
        Lexer3.prototype.createOffsetOnlyToken = function(image2, startOffset, tokenTypeIdx, tokenType) {
          return {
            image: image2,
            startOffset,
            tokenTypeIdx,
        ...
        Lexer3.prototype.createStartOnlyToken = function(image2, startOffset, tokenTypeIdx, tokenType, startLine, startColumn) {
          return {
            image: image2,
            startOffset,
            startLine,
        ...
        Lexer3.prototype.createFullToken = function(image2, startOffset, tokenTypeIdx, tokenType, startLine, startColumn, imageLength) {
          return {
            image: image2,
            startOffset,
...
var require_tokens_public = __commonJS({
  "node_modules/chevrotain/lib/src/scan/tokens_public.js"(exports2) {
    ...
    function createTokenInstance2(tokType, image2, startOffset, endOffset, startLine, endLine, startColumn, endColumn) {
      return {
        image: image2,
        startOffset,
        endOffset,
  ...
  "node_modules/chevrotain/lib/src/parse/grammar/llk_lookahead.js"(exports2) {
    ...
    var LLkLookaheadStrategy2 = (
      ...
      (function() {
        ...
        LLkLookaheadStrategy3.prototype.validateNoLeftRecursion = function(rules2) {
          return (0, flatMap_1.default)(rules2, function(currTopRule) {
            return (0, checks_1.validateNoLeftRecursion)(currTopRule, currTopRule, errors_public_1.defaultGrammarValidatorErrorProvider);
          });
        };
        LLkLookaheadStrategy3.prototype.validateEmptyOrAlternatives = function(rules2) {
          return (0, flatMap_1.default)(rules2, function(currTopRule) {
            return (0, checks_1.validateEmptyOrAlternative)(currTopRule, errors_public_1.defaultGrammarValidatorErrorProvider);
          });
        };
        LLkLookaheadStrategy3.prototype.validateAmbiguousAlternationAlternatives = function(rules2, maxLookahead) {
          return (0, flatMap_1.default)(rules2, function(currTopRule) {
        ...
        LLkLookaheadStrategy3.prototype.validateSomeNonEmptyLookaheadPath = function(rules2, maxLookahead) {
          return (0, checks_1.validateSomeNonEmptyLookaheadPath)(rules2, maxLookahead, errors_public_1.defaultGrammarValidatorErrorProvider);
        };
  ...
  "node_modules/chevrotain/lib/src/parse/parser/traits/looksahead.js"(exports2) {
    ...
    var LooksAhead = (
      ...
      (function() {
        ...
        LooksAhead2.prototype.preComputeLookaheadFunctions = function(rules2) {
          var _this = this;
          (0, forEach_1.default)(rules2, function(currRule) {
...
var require_model2 = __commonJS({
  "node_modules/@chevrotain/cst-dts-gen/lib/src/model.js"(exports2) {
    ...
    var groupBy_1 = __importDefault(require_groupBy());
    var assign_1 = __importDefault(require_assign());
    function buildModel2(productions) {
...
// src/lexer.ts
var NameToken = createToken({ name: "NameToken", pattern: Lexer.NA });
function keyword(name) {
  return createToken({
    name: `Kw_${name}`,
    // word boundaries so keywords never match inside longer identifiers
    // (e.g. `in` must not match in `involvedFunctionalExchanges`)
    pattern: new RegExp(`\\b${name}\\b`),
    categories: [NameToken]
  });
}
var Kw_occurrence = keyword("occurrence");
var Kw_def = keyword("def");
var Kw_package = keyword("package");
var Kw_metadata = keyword("metadata");
var Kw_private = keyword("private");
var Kw_public = keyword("public");
var Kw_import = keyword("import");
var Kw_action = keyword("action");
var Kw_part = keyword("part");
var Kw_port = keyword("port");
var Kw_item = keyword("item");
var Kw_doc = keyword("doc");
var Kw_description = keyword("description");
var Kw_flow = keyword("flow");
var Kw_from = keyword("from");
var Kw_to = keyword("to");
var Kw_perform = keyword("perform");
var Kw_succession = keyword("succession");
var Kw_first = keyword("first");
var Kw_start = keyword("start");
var Kw_then = keyword("then");
var Kw_done = keyword("done");
var Kw_ref = keyword("ref");
var Kw_interface = keyword("interface");
var Kw_connect = keyword("connect");
var Kw_allocate = keyword("allocate");
var Kw_allocation = keyword("allocation");
var Kw_requirement = keyword("requirement");
var Kw_subject = keyword("subject");
var Kw_assert = keyword("assert");
var Kw_satisfy = keyword("satisfy");
var Kw_in = keyword("in");
var Kw_out = keyword("out");
var Kw_bind = keyword("bind");
var Kw_attribute = keyword("attribute");
var Kw_library = keyword("library");
var Kw_abstract = keyword("abstract");
var Kw_default = keyword("default");
var Kw_nonunique = keyword("nonunique");
var Kw_state = keyword("state");
var Kw_enum = keyword("enum");
var Kw_connection = keyword("connection");
var Kw_exhibit = keyword("exhibit");
var Kw_calc = keyword("calc");
var Kw_view = keyword("view");
var Kw_return = keyword("return");
var Kw_dependency = keyword("dependency");
var Kw_individual = keyword("individual");
var Kw_by = keyword("by");
var Kw_analysis = keyword("analysis");
var Kw_comment = keyword("comment");
var Kw_do = keyword("do");
var Kw_require = keyword("require");
var Kw_ordered = keyword("ordered");
var Kw_constraint = keyword("constraint");
var Kw_inout = keyword("inout");
var Kw_timeslice = keyword("timeslice");
var Kw_snapshot = keyword("snapshot");
var Kw_transition = keyword("transition");
var Kw_accept = keyword("accept");
var Kw_end = keyword("end");
var Kw_and = keyword("and");
var Kw_not = keyword("not");
var Kw_istype = keyword("istype");
...
var Number = createToken({
  name: "Number",
  pattern: /\d+(\.\d+)?([eE][+-]?\d+)?/
});
var Multiplicity = createToken({
  name: "Multiplicity",
  pattern: /\[[^\]\n]*\]/
});
var ColonGtGt = createToken({ name: "ColonGtGt", pattern: /:>>/ });
var ColonColonGt = createToken({ name: "ColonColonGt", pattern: /::>/ });
var Arrow = createToken({ name: "Arrow", pattern: /->/ });
var ColonGt = createToken({ name: "ColonGt", pattern: /:>/ });
var ColonColon = createToken({ name: "ColonColon", pattern: /::/ });
...
var LAngle = createToken({ name: "LAngle", pattern: /</ });
var RAngle = createToken({ name: "RAngle", pattern: />/ });
...
var allTokens = [
  // category for all name-like tokens (not matched by the lexer itself)
  NameToken,
  // skipped
  Whitespace,
  LineComment,
  ...
  Kw_dependency,
  Kw_individual,
  // Apollo work item D keywords (D1–D13, see group comment above)
  Kw_by,
  Kw_analysis,
  Kw_comment,
  Kw_do,
  ...
  Hash,
  Tilde,
  // arithmetic operators (after the comment tokens, so a `//`-comment match
  // is always preferred over a single Slash)
  Plus,
  Minus,
  Slash,
  Caret
];
var sysmlLexer = new Lexer(allTokens);
function tokenize(source) {
  const result = sysmlLexer.tokenize(source);
  return { tokens: result.tokens, errors: result.errors };
}

// src/parser.ts
var SysmlParser = class extends CstParser {
  constructor() {
    super(allTokens, { maxLookahead: 4 });
    this.performSelfAnalysis();
  }
  // -------------------------------------------------------------------------
  // Entry point: a model is a sequence of members
  // -------------------------------------------------------------------------
  model = this.RULE("model", () => {
    this.MANY(() => this.SUBRULE(this.member));
  });
  /**
   * A member is any construct that can appear inside a package, occurrence,
   * action, part, port, interface, or requirement body.
   */
  member = this.RULE("member", () => {
    this.OR({
      DEF: [
        { ALT: () => this.SUBRULE(this.blockComment) },
        { ALT: () => this.SUBRULE(this.docMember) },
        { ALT: () => this.SUBRULE(this.importMember) },
        { ALT: () => this.SUBRULE(this.metadataMember) },
        { ALT: () => this.SUBRULE(this.atMetadata) },
        { ALT: () => this.SUBRULE(this.packageMember) },
        { ALT: () => this.SUBRULE(this.occurrenceMember) },
        { ALT: () => this.SUBRULE(this.actionMember) },
        // `part :>> name [mult] (body|;)` (Apollo D13, redefinition usage in
        // the Execution timeline) shares the Kw_part first token with
        // partMember — GATE'd on the `:>>` right after `part` (mirrors the
        // attributeMember pattern).
        {
          ALT: () => this.SUBRULE(this.partRedefMember),
          GATE: () => this.LA(1).tokenType === Kw_part && this.LA(2).tokenType === ColonGtGt
        },
        {
          ALT: () => this.SUBRULE(this.partMemberWrapper),
          GATE: () => !(this.LA(1).tokenType === Kw_part && this.LA(2).tokenType === ColonGtGt)
        },
        { ALT: () => this.SUBRULE(this.itemMember) },
        { ALT: () => this.SUBRULE(this.portMember) },
        // `abstract interface def X { … }` is GATE'd on the full prefix
        // (Kw_abstract is shared by action/part/item/connection members,
        // and Kw_interface by the def/usage interface forms below). Per the
        // SysML v2 BNF `abstract` is the only definition prefix interface
        // takes — deliberately no `individual` support; and the abstract
        // *usage* form (`abstract interface i1;`) is likewise not supported
        // yet: the GATE requires Kw_def (asymmetric with partMember's
        // OPTION(Kw_abstract)), so `abstract interface i1;` fails to parse.
        {
          ALT: () => this.SUBRULE(this.abstractInterfaceDefMember),
          GATE: () => this.LA(1).tokenType === Kw_abstract && this.LA(2).tokenType === Kw_interface && this.LA(3).tokenType === Kw_def
        },
        // `interface def X { end … }` (Apollo D12) shares the Kw_interface
        // first token with the usage-form interfaceMember below — GATE'd on
        // the Kw_def marker (mirrors the attributeMember pattern).
        {
          ALT: () => this.SUBRULE(this.interfaceDefMember),
          GATE: () => this.LA(1).tokenType === Kw_interface && this.LA(2).tokenType === Kw_def
        },
        {
          ALT: () => this.SUBRULE(this.interfaceMember),
          GATE: () => !(this.LA(1).tokenType === Kw_interface && this.LA(2).tokenType === Kw_def)
        },
        { ALT: () => this.SUBRULE(this.allocationMember) },
        { ALT: () => this.SUBRULE(this.dependencyMember) },
        { ALT: () => this.SUBRULE(this.annotatedDependencyMember) },
        { ALT: () => this.SUBRULE(this.requirementMember) },
        { ALT: () => this.SUBRULE(this.subjectMember) },
        { ALT: () => this.SUBRULE(this.assertMember) },
        // `satisfy R by …;` (Apollo D2) — standalone Kw_satisfy member.
        { ALT: () => this.SUBRULE(this.satisfyMember) },
        // `require constraint { … }` (Apollo D11) — requirement-frame
        // constraint member with no trailing semicolon.
        { ALT: () => this.SUBRULE(this.requireMember) },
        { ALT: () => this.SUBRULE(this.flowMember) },
        { ALT: () => this.SUBRULE(this.successionMember) },
        { ALT: () => this.SUBRULE(this.performMember) },
        { ALT: () => this.SUBRULE(this.refMember) },
        { ALT: () => this.SUBRULE(this.attributeMember) },
        { ALT: () => this.SUBRULE(this.featureMember) },
        { ALT: () => this.SUBRULE(this.stateMember) },
        { ALT: () => this.SUBRULE(this.exhibitMember) },
        { ALT: () => this.SUBRULE(this.enumMember) },
        { ALT: () => this.SUBRULE(this.connectionMember) },
        { ALT: () => this.SUBRULE(this.calcMember) },
        { ALT: () => this.SUBRULE(this.viewMember) },
        { ALT: () => this.SUBRULE(this.returnMember) },
        // Apollo D3: `analysis def X { … }` (calc-shaped analysis members).
        { ALT: () => this.SUBRULE(this.analysisMember) },
        // Apollo D7: `comment source /* … */` / `comment cost /* … */`.
        { ALT: () => this.SUBRULE(this.commentMember) },
        // Apollo D8: `do action x { … }` state-body members.
        { ALT: () => this.SUBRULE(this.doMember) },
        // Apollo D13: `timeslice t { … }` / `then timeslice t { … }`,
        // `snapshot x { … }`, `first start;`, `then …;` timeline members.
        { ALT: () => this.SUBRULE(this.timesliceMember) },
        { ALT: () => this.SUBRULE(this.thenMember) },
        { ALT: () => this.SUBRULE(this.firstMember) },
        { ALT: () => this.SUBRULE(this.snapshotMember) },
        // MissionPackage state machines: `transition first a accept T then b { … }`
        { ALT: () => this.SUBRULE(this.transitionMember) },
        // Connection/interface bodies: `end capa ::> x;` / `end source : ~P;`
        { ALT: () => this.SUBRULE(this.endMember) },
        // Analysis/calc bodies: bare `name (: Type)? = expr;` locals
        // (`sic = launchVehicle.stage1;`, `fullStack = (a, b);`). GATED on a
        // NON-keyword name: the rule itself starts with the NameToken CATEGORY
        // (whose members include every keyword), and a GATE on the category
        // would either make the OR ambiguous or never match — so the GATE
        // names the concrete Identifier/QuotedName tokens instead.
        {
          ALT: () => this.SUBRULE(this.localMember),
          GATE: () => isPlainName(this.LA(1).tokenType)
        }
      ]
    });
  });
  ...
  docMember = this.RULE("docMember", () => {
    this.CONSUME(Kw_doc);
    this.OPTION(() => this.CONSUME(Kw_description));
    this.CONSUME(BlockComment);
  });
  ...
  qualifiedName = this.RULE("qualifiedName", () => {
    ...
    this.MANY(() => {
      this.OR([
        { ALT: () => this.CONSUME(ColonColon) },
        { ALT: () => this.CONSUME(Dot) }
      ]);
      this.OR2([
        { ALT: () => this.CONSUME(Star) },
        // `**` recursive wildcard (`private import Pkg::**;`, Apollo D9)
        { ALT: () => this.CONSUME(StarStar) },
        { ALT: () => this.CONSUME2(NameToken) }
      ]);
    });
  });
  /** A parenthesized list of references, e.g. `(a, 'B'.c)` */
  tuple = this.RULE("tuple", () => {
    this.CONSUME(LParen);
    this.OPTION(() => {
  ...
  // Members
  // -------------------------------------------------------------------------
  importMember = this.RULE("importMember", () => {
    this.OPTION(
      () => this.OR([
        { ALT: () => this.CONSUME(Kw_private) },
        { ALT: () => this.CONSUME(Kw_public) }
      ])
    );
  ...
  metadataMember = this.RULE("metadataMember", () => {
    this.CONSUME(Kw_metadata);
    this.CONSUME(NameToken);
    this.CONSUME(LBrace);
  ...
  atMetadata = this.RULE("atMetadata", () => {
    this.CONSUME(At);
    this.CONSUME(NameToken);
    this.CONSUME(LBrace);
    this.MANY(() => this.SUBRULE(this.metadataProperty));
  ...
  occurrenceMember = this.RULE("occurrenceMember", () => {
    ...
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.CONSUME(Multiplicity));
    this.OPTION4(() => {
      this.CONSUME(Colon);
      this.SUBRULE(this.qualifiedName);
    });
  ...
  /** `abstract action def Operation;` / `action subfunctions[*] : Function
   *  :>> subactions;` — optional `abstract`, `def`, short name, name
   *  multiplicity, and an optional `: Type` / `:>> redef` tail (CP:29 keeps
   *  the `:>>` after the type). */
  actionMember = this.RULE("actionMember", () => {
    this.OPTION(() => this.CONSUME(Kw_abstract));
    this.CONSUME(Kw_action);
    this.OPTION2(() => this.CONSUME(Kw_def));
    this.OPTION3(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION4(() => this.CONSUME(Multiplicity));
    this.OPTION5(() => this.SUBRULE(this.actionTail));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
   ...
   *  (`: MassedComponent [*] default null`). The `individual` prefix sits
   *  AFTER `abstract`, before the kind keyword — per the SysML v2 spec Annex
   *  B grammar (clause 8.2.2.9, SysML-textual-bnf.kebnf; mirrored in
   *  SysML.xtext of the SysML-v2-Pilot-Implementation):
   *    OccurrenceDefinitionPrefix =
   *        BasicDefinitionPrefix?
   *        ( isIndividual ?= 'individual' … )?
   *        DefinitionExtensionKeyword*
   *  with `BasicDefinitionPrefix = isAbstract ?= 'abstract' | isVariation ?=
   *  'variation'` — i.e. BNF order `abstract? individual? part`, so the
   *  reverse order (`individual abstract part`) is deliberately rejected
   *  (the usage side is the same: `OccurrenceUsagePrefix = BasicUsagePrefix
   *  ( isIndividual ?= 'individual' )? …`, with `abstract` inside
   *  `BasicUsagePrefix`/`RefPrefix`). */
  partMember = this.RULE("partMember", () => {
    this.OPTION(() => this.CONSUME(Kw_abstract));
    this.OPTION2(() => this.CONSUME(Kw_individual));
    this.CONSUME(Kw_part);
    this.OPTION3(() => this.CONSUME(Kw_def));
    this.OPTION4(() => this.SUBRULE(this.shortName));
    this.OPTION5(() => this.CONSUME2(NameToken));
    this.OPTION6(() => this.CONSUME(Multiplicity));
    this.OPTION7(() => this.CONSUME(Kw_ordered));
    this.OPTION8(() => this.SUBRULE(this.typedTail));
    this.OPTION9(() => this.SUBRULE(this.attrValueOrDefault));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
  });
  /** Apollo D4: a part member followed by the post-body specialization tail
   *  (`part 'as-201' : Mission { … } :> missions;`). A separate wrapper rule
   *  because partMember itself is at Chevrotain's 9-OPTION limit. */
  partMemberWrapper = this.RULE("partMemberWrapper", () => {
    this.SUBRULE(this.partMember);
    this.OPTION(() => this.SUBRULE2(this.postBodyTail));
  });
  /** `item def Concern;` / `item concerns[*]: Concern;` — optional
   *  `abstract`, `def`, short name, name multiplicity, `: type` / `:> specs`
   *  tail, and body-or-semicolon ending. */
  itemMember = this.RULE("itemMember", () => {
    this.OPTION(() => this.CONSUME(Kw_abstract));
    this.CONSUME(Kw_item);
    this.OPTION2(() => this.CONSUME(Kw_def));
    this.OPTION3(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION4(() => this.CONSUME(Multiplicity));
    this.OPTION5(() => this.SUBRULE(this.typedTail));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
    this.OPTION6(() => this.SUBRULE2(this.postBodyTail));
  });
  /** `port cmInterfacePort : ~LaunchEscapeSystemPort;` (usage — the leading
   *  `~` is the SysML v2 conjugation operator, kept verbatim in the rendered
   *  `type`) or `port def PayloadInterfacePort { … }` (definition form). The
   *  optional `def` is GATE-free: Kw_def is a dedicated token and no other
   *  member starts with Kw_port, so `port def` is unambiguous. The optional
   *  `: [~] qualifiedName` type tail is USAGE-ONLY (GATE'd away after `def`):
   *  per the SysML v2 BNF `: Type` (and `~` conjugation) is the usage/typed
   *  form, while a definition specializes via `:>` — and no Apollo 11 fixture
   *  writes `port def X : T` anyway. Ending is body-or-semicolon (body
   *  members flow through the shared `member` rule). Deliberately no name
   *  multiplicity and no `:> S` specialization tail: the fixtures use neither
   *  on ports. */
  portMember = this.RULE("portMember", () => {
    this.CONSUME(Kw_port);
    const defTok = this.OPTION(() => this.CONSUME(Kw_def));
    this.CONSUME2(NameToken);
    this.OPTION2({
      GATE: () => defTok === void 0,
      DEF: () => {
        this.CONSUME(Colon);
        this.OPTION3(() => this.CONSUME(Tilde));
        this.SUBRULE(this.qualifiedName);
      }
    });
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME2(Semicolon) }
    ]);
  });
  /** `interface cable : ComponentExchange connect A to B { ... }` (usage
   *  form; the NAME is optional — TechnicalComponents writes a nameless
   *  `interface : StagingInterface connect A to B;`). */
  interfaceMember = this.RULE("interfaceMember", () => {
    this.CONSUME(Kw_interface);
    this.OPTION(() => this.CONSUME(NameToken));
    this.CONSUME(Colon);
    this.SUBRULE(this.qualifiedName);
    this.CONSUME(Kw_connect);
    this.SUBRULE2(this.qualifiedName);
    this.CONSUME(Kw_to);
    this.SUBRULE3(this.qualifiedName);
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
  ...
  abstractInterfaceDefMember = this.RULE("abstractInterfaceDefMember", () => {
    ...
    this.SUBRULE(this.interfaceDefMember);
  });
  /** `interface def StagingInterface { end source : StagingPort; … }`
   *  (Apollo D12 — definition form: `def` + name + body; the `end` members
   *  flow through the shared `member` rule). */
  interfaceDefMember = this.RULE("interfaceDefMember", () => {
    this.CONSUME(Kw_interface);
    this.CONSUME2(Kw_def);
    this.CONSUME3(NameToken);
    this.body();
  });
  /** `allocation : ExchangeAllocation allocate X to cable;` */
  allocationMember = this.RULE("allocationMember", () => {
    this.CONSUME(Kw_allocation);
    this.CONSUME(Colon);
    this.SUBRULE(this.qualifiedName);
    this.CONSUME(Kw_allocate);
    this.SUBRULE2(this.qualifiedName);
    this.CONSUME(Kw_to);
    this.CONSUME(NameToken);
    this.CONSUME(Semicolon);
  });
  /** `dependency <source> to <target>;` (SysML v2 DependencyMember) — the
   *  client-`to`-supplier form used 369× by the Apollo 11 fixtures
   *  (`#refinement dependency 'FLR-R001' to MissionRequirementsPackage::'HLR-R001';`).
   *  The <source> is a simple (possibly quoted) name; the <target> is a full
   *  qualified name. The BNF also allows an `Identification 'from'` clause and
   *  comma-separated client/supplier lists — the model never uses those, so
   *  they are intentionally NOT accepted (no speculative forms; see the work
   *  item notes). Chevrotain picks this alternative on the leading
   *  Kw_dependency token (disjoint first set). */
  dependencyMember = this.RULE("dependencyMember", () => {
    this.CONSUME(Kw_dependency);
    this.CONSUME(NameToken);
    this.CONSUME(Kw_to);
    this.SUBRULE(this.qualifiedName);
    this.CONSUME(Semicolon);
  });
  /** `#refinement dependency <source> to <target>;` (SysML v2
   *  PrefixMetadataAnnotation + DependencyMember, BNF Clause 8.2.2.27): the
   *  `#`-prefixed metadata-annotation keyword attaches to the FOLLOWING member
   *  — here the dependency member (the only annotated member the fixtures
   *  use; structured as a wrapper around dependencyMember — the pattern
   *  extends by adding one wrapper rule per annotated member kind). The
   *  annotation name is any name-like token (none of the existing members
   *  start with `#`, so the member OR is unambiguous). */
  annotatedDependencyMember = this.RULE("annotatedDependencyMember", () => {
    this.CONSUME(Hash);
    this.CONSUME(NameToken);
   ...
   *  shared typedTail), mirroring partMember. */
  requirementMember = this.RULE("requirementMember", () => {
    this.CONSUME(Kw_requirement);
    this.OPTION(() => this.CONSUME(Kw_def));
    this.OPTION2(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.CONSUME(Multiplicity));
    this.OPTION4(() => this.SUBRULE(this.typedTail));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
  ...
  /** `assert satisfy requirement 'req-1';` or (Apollo D3/D11/D13)
   *  `assert constraint { valueExpression }` — a constraint clause with NO
   *  trailing semicolon (`assert constraint { powerMargin > 0[W] }` followed
   *  directly by the body's `}` or the next member). */
  assertMember = this.RULE("assertMember", () => {
    this.CONSUME(Kw_assert);
    this.OR([
      {
        ALT: () => {
          this.CONSUME(Kw_satisfy);
          this.CONSUME2(Kw_requirement);
          this.CONSUME3(NameToken);
          this.CONSUME(Semicolon);
        },
        GATE: () => this.LA(1).tokenType === Kw_satisfy
      },
      {
        ALT: () => this.SUBRULE(this.constraintClause),
        GATE: () => this.LA(1).tokenType === Kw_constraint
      }
    ]);
  });
  /** `flow 'Name' : Type from A to B;` or `flow A to B;` */
  flowMember = this.RULE("flowMember", () => {
    this.CONSUME(Kw_flow);
    this.OR([
      {
        ALT: () => {
          this.CONSUME(NameToken);
      ...
      },
      {
        ALT: () => {
          this.SUBRULE3(this.qualifiedName);
          this.CONSUME2(Kw_to);
          this.SUBRULE4(this.qualifiedName);
          this.CONSUME2(Semicolon);
        }
      }
    ]);
  });
  /** `succession first start then A.B;` */
  successionMember = this.RULE("successionMember", () => {
    this.CONSUME(Kw_succession);
    this.CONSUME(Kw_first);
    this.OR([
      {
        ALT: () => this.CONSUME(Kw_start),
        GATE: () => this.LA(1).tokenType === Kw_start
      },
      {
        ALT: () => this.SUBRULE(this.qualifiedName),
        GATE: () => this.LA(1).tokenType !== Kw_start
    ...
    this.OR2([
      {
        ALT: () => this.CONSUME(Kw_done),
        GATE: () => this.LA(1).tokenType === Kw_done
      },
      {
        ALT: () => this.SUBRULE2(this.qualifiedName),
        GATE: () => this.LA(1).tokenType !== Kw_done
      }
    ]);
    this.CONSUME(Semicolon);
  });
  /** `perform 'Root Function'.'Capture Movement';` / `perform action x : T;`
   *  (Apollo D6) / `perform X::Y :>> Y;` (the Execution timeline redefinition
   *  form, D13). One optional `action` designator, one optional `: Type` tail
   *  and one optional `:>> redef` tail after the (possibly qualified) target. */
  performMember = this.RULE("performMember", () => {
    this.CONSUME(Kw_perform);
    this.OPTION(() => this.CONSUME(Kw_action));
    this.SUBRULE(this.qualifiedName);
    this.OPTION2(() => {
      this.CONSUME(Colon);
      this.SUBRULE2(this.qualifiedName);
    ...
    this.OPTION3(() => {
      this.CONSUME(ColonGtGt);
      this.SUBRULE3(this.qualifiedName);
    });
    this.CONSUME(Semicolon);
  });
  /** `ref item :>> allocatedFunctionPorts = ('A'.b);` (chained-redefinition
   *  form, existing) or `ref part capability[1] : Capability :> participant;`
   *  (kind-qualified usage form, CP:80/81). The two are disjoint on lookahead
   *  2: a `:>>` right after the first name picks the redefinition form; a kind
   *  keyword (part/item/requirement/attribute/port/action) that is NOT followed
   *  by `:>>` picks the usage form. Both alternatives carry GATEs (like
   *  attributeMember), so the shared NameToken first set stays unambiguous. */
  refMember = this.RULE("refMember", () => {
    this.CONSUME(Kw_ref);
    this.OR([
      {
        // usage form: `ref <kind> name [mult] (: T (+ mult)?)? (:> S (, S)*)? ;`
        ALT: () => {
          this.CONSUME2(NameToken);
          this.CONSUME3(NameToken);
          this.OPTION(() => this.CONSUME(Multiplicity));
          this.OPTION2(() => {
            this.CONSUME(Colon);
            this.SUBRULE(this.qualifiedName);
            this.OPTION3(() => this.CONSUME2(Multiplicity));
          });
          this.OPTION4(() => {
            this.CONSUME(ColonGt);
            this.SUBRULE2(this.qualifiedName);
            this.MANY(() => {
              this.CONSUME(Comma);
              this.SUBRULE3(this.qualifiedName);
        ...
        GATE: () => isRefKind(this.LA(1).tokenType) && this.LA(2).tokenType !== ColonGtGt
      },
      {
        // redefinition form: `ref <name> :>> <name> = (<qn>, …);`
        ALT: () => {
          this.CONSUME4(NameToken);
          this.CONSUME(ColonGtGt);
          this.CONSUME5(NameToken);
          this.CONSUME(Equals);
          this.SUBRULE(this.tuple);
          this.CONSUME2(Semicolon);
        },
        GATE: () => this.LA(2).tokenType === ColonGtGt
      }
    ]);
  });
  /** `{ member* }` for bodies. */
  ...
  /** `<$ymb>` short-name group, e.g. `<kN>`, `<'%'>`. Own RULE so the many
   *  member rules that accept it stay under Chevrotain's per-rule DSL
   *  occurrence limits. AST reads `shortName` from this node. */
  shortName = this.RULE("shortName", () => {
    this.CONSUME(LAngle);
    this.CONSUME2(NameToken);
    this.CONSUME(RAngle);
  });
  /** The `: T1, T2 … [:> | :>> S (, S)*]` / `:> S (, S)* [: T]`
   *  type/specialization tail shared by part, item, attribute, requirement,
   *  state, enum, connection, calc and view members. Accepts a comma-separated
   *  TYPE LIST (`part crew[1..*] : Astronaut, LogicalComponentsPackage::Crew
   *  :>> crew;` — Apollo MissionPackage), an optional `nonunique` after the
   *  type(s) (used by attributes; harmless elsewhere), and BOTH `:>` and
   *  `:>>` specialization/redefinition markers after the type (`individual
   *  part csm : 'CSM-107' :>> commandServiceModule;` — Apollo D13). */
  typedTail = this.RULE("typedTail", () => {
    this.OR([
      {
        // `: Type (, Type)* [mult] nonunique? ((:> | :>>) S (, S)*)?`
        ALT: () => {
          this.CONSUME(Colon);
          this.SUBRULE(this.qualifiedName);
          this.MANY(() => {
          ...
          this.OPTION(() => this.CONSUME(Multiplicity));
          this.OPTION2(() => this.CONSUME(Kw_nonunique));
          this.OPTION3(() => {
            this.OR2([
              { ALT: () => this.CONSUME(ColonGt) },
              { ALT: () => this.CONSUME(ColonGtGt) }
            ]);
            this.SUBRULE3(this.qualifiedName);
            this.MANY2(() => {
              this.CONSUME2(Comma);
      ...
      },
      {
        // `:> S (, S)* (: Type [mult])?`
        ALT: () => {
          this.CONSUME2(ColonGt);
          this.SUBRULE5(this.qualifiedName);
          this.MANY3(() => {
            this.CONSUME3(Comma);
            this.SUBRULE6(this.qualifiedName);
          });
          this.OPTION4(() => {
            this.CONSUME2(Colon);
            this.SUBRULE7(this.qualifiedName);
            this.OPTION5(() => this.CONSUME2(Multiplicity));
          });
        }
      }
    ]);
  });
  /** The action tail `: T [:> | :>> R (, R)*]` / `[:> | :>> R (, R)* (: T)?]` —
   *  the Apollo D1 fixture form is `action def X :> Function { … }` (a `:>`
   *  specialization with no type); CP:29 keeps the `:>>` redefinition after
   *  the type. Both markers are accepted in both positions. */
  actionTail = this.RULE("actionTail", () => {
    this.OR([
      {
        ALT: () => {
          this.CONSUME(Colon);
      ...
      },
      {
        ALT: () => {
          this.OR3([
            { ALT: () => this.CONSUME3(ColonGtGt) },
            { ALT: () => this.CONSUME3(ColonGt) }
          ]);
          this.SUBRULE4(this.qualifiedName);
          this.MANY2(() => {
            this.CONSUME2(Comma);
          ...
          this.OPTION3(() => {
            this.CONSUME2(Colon);
            this.SUBRULE6(this.qualifiedName);
            this.OPTION4(() => this.CONSUME2(Multiplicity));
          });
        }
      }
    ]);
  });
  /** `= valueExpression` assignment (attribute redefinitions). */
  attrAssign = this.RULE("attrAssign", () => {
    this.CONSUME(Equals);
    this.SUBRULE(this.valueExpression);
  });
  /** `= valueExpression` or `default valueExpression` on a plain attribute. */
  attrValueOrDefault = this.RULE("attrValueOrDefault", () => {
    this.OR([
      { ALT: () => this.SUBRULE(this.attrAssign) },
      {
        ALT: () => {
          this.CONSUME2(Kw_default);
          this.SUBRULE(this.valueExpression);
        }
      }
    ]);
  });
  /** ALT1 of attributeMember: the plain `attribute` feature/usage.
   *  `[<short>] name [mult] tail? value? (body|;)` where `tail` is the shared
   *  typedTail and `value` is attrValueOrDefault. AST resolves the short name
   *  from the shortName subrule and `name` from the first direct NameToken. */
  attributeUsual = this.RULE("attributeUsual", () => {
    this.CONSUME(Kw_attribute);
    this.OPTION(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION2(() => this.CONSUME(Multiplicity));
    this.OPTION3(() => this.SUBRULE2(this.typedTail));
    this.OPTION4(() => this.SUBRULE(this.attrValueOrDefault));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME(Semicolon) }
    ]);
  });
  /** ALT2 of attributeMember: `attribute :>> name (: Type [mult])? (= expr)?
   *  (body|;)` — redefinition, optionally with a type (QU:19) and/or body. */
  attributeRedef = this.RULE("attributeRedef", () => {
    this.CONSUME(Kw_attribute);
    this.CONSUME2(ColonGtGt);
    this.CONSUME3(NameToken);
    this.OPTION(() => {
      this.CONSUME(Colon);
      this.SUBRULE(this.qualifiedName);
    ...
    this.OPTION3(() => this.SUBRULE(this.attrAssign));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME2(Semicolon) }
    ]);
  });
  /** ALT3 of attributeMember: bare `:>> name` with no keyword, used nested
   *  inside attribute bodies. `:>> name = expr;` (QU:28, QU:43/44), `:>> name :
   *  Type { body }` (QU:34–40), or `:>> name { body }` (QU:44) — an optional
   *  `: Type` tail, optional `= expr` value, and body-or-semicolon ending. */
  attributeBareRedef = this.RULE("attributeBareRedef", () => {
    this.CONSUME(ColonGtGt);
    this.CONSUME2(NameToken);
    this.OPTION(() => {
      this.CONSUME(Colon);
  ...
  /** ALT4 of attributeMember: `attribute def name (: Type)? (:> list)?
   *  (body|;)` — an attribute definition (QU:17, work item 6). */
  ...
  /** ALT5 of attributeMember: bare `:> name = expr;` subset-assign form
   *  (`:> influenceLevel = StakeholderInfluenceLevel::high;` — Apollo D5).
   *  The single `:>` marker distinguishes it from the `:>>` redefinition
   *  form without one, and the GATE keeps `:>>` behavior unchanged. */
  attributeBareSubset = this.RULE("attributeBareSubset", () => {
    this.CONSUME(ColonGt);
    this.CONSUME2(NameToken);
    this.OPTION(() => this.SUBRULE(this.attrAssign));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME2(Semicolon) }
    ]);
  });
  /** attribute members (work item 4): a `private?` prefix then one of four
   *  forms. ALT1 = attributeUsual, ALT2 = attributeRedef (:>> with keyword),
   *  ALT3 = attributeBareRedef, ALT4 = attributeDef, ALT5 = attributeBareSubset
   *  (the Apollo D5 bare `:> name = expr;`). */
  attributeMember = this.RULE("attributeMember", () => {
    this.OPTION(() => this.CONSUME(Kw_private));
    this.OR([
      {
        ALT: () => this.SUBRULE(this.attributeUsual),
        GATE: () => this.LA(1).tokenType === Kw_attribute && this.LA(2).tokenType !== ColonGtGt && this.LA(2).tokenType !== Kw_def
      },
      {
        ALT: () => this.SUBRULE2(this.attributeRedef),
        GATE: () => this.LA(1).tokenType === Kw_attribute && this.LA(2).tokenType === ColonGtGt
      },
      {
        ALT: () => this.SUBRULE3(this.attributeBareRedef),
        GATE: () => this.LA(1).tokenType === ColonGtGt
      },
      {
        ALT: () => this.SUBRULE4(this.attributeDef),
        GATE: () => this.LA(1).tokenType === Kw_attribute && this.LA(2).tokenType === Kw_def
      },
      {
        ALT: () => this.SUBRULE5(this.attributeBareSubset),
        GATE: () => this.LA(1).tokenType === ColonGt
      }
    ]);
  });
  /** `out FOP1 [0..*] : ExchangeItem = (a, b);` / `in x: DataValue[1];`
   *  (QU:79) / `inout item loads : StructuralLoad;` (Apollo D12 — directional
   *  item members inside port/interface defs) / `out totalPowerGenerated :>
   *  ISQ::power = rollupPowerGeneration(systemToAnalyze);` (Apollo D3 — a
   *  directed feature with a `:> specialization` and an `= expression`
   *  assignment). Direction, optional `item` designator, optional name and
   *  name multiplicity, `: type` *or* `:> specialization`, optional type
   *  multiplicity, and an optional `= (tuple)` or `= expression` value. */
  featureMember = this.RULE("featureMember", () => {
    this.OR([
      { ALT: () => this.CONSUME(Kw_in) },
      { ALT: () => this.CONSUME(Kw_out) },
      { ALT: () => this.CONSUME(Kw_inout) }
    ]);
    this.OPTION(() => this.CONSUME(Kw_item));
    this.OPTION2(() => this.CONSUME2(NameToken));
    this.OPTION3(() => this.CONSUME(Multiplicity));
    this.OR2([
      {
        ALT: () => {
    ...
    this.OPTION5(() => {
      ...
      this.OR3([
        ...
        {
          ALT: () => this.SUBRULE2(this.valueExpression),
          GATE: () => this.LA(1).tokenType !== LParen
        }
      ]);
    });
  ...
  // -------------------------------------------------------------------------
  // Work item 5 — state, exhibit, enum, connection, calc, view, return
  // -------------------------------------------------------------------------
  /** `state def Phase :> StateAction;` (CP:54) — state definition or usage,
   *  sharing the partMember shape (def? / short name / name / multiplicity /
   *  typed tail / body-or-semicolon). No `abstract` prefix appears in the
   *  fixtures, so none is accepted here. */
  stateMember = this.RULE("stateMember", () => {
    this.CONSUME(Kw_state);
    this.OPTION(() => this.CONSUME(Kw_def));
    this.OPTION2(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.CONSUME(Multiplicity));
  ...
  /** `exhibit state phases : StateAction;` (CP:68) / `exhibit state
   *  apollo11Phases { … } :>> phases;` (Apollo MissionPackage — a body and a
   *  post-body `:>`/`:>>` tail). The exhibit designator exposes the state
   *  feature; body members flow through the shared `member` rule. */
  exhibitMember = this.RULE("exhibitMember", () => {
    this.CONSUME(Kw_exhibit);
    this.CONSUME2(Kw_state);
    this.SUBRULE(this.qualifiedName);
    this.OPTION(() => {
      this.CONSUME(Colon);
      this.SUBRULE2(this.qualifiedName);
    ...
    this.OPTION2(() => this.SUBRULE3(this.postBodyTail));
  });
  /** `enum def StakeholderInfluenceKind { enum direct; enum indirect; }`
   *  (CP:88–90) — an enum definition or an `enum <name>;` literal/usage
   *  (name only, semicolon). Shares the partMember shape. */
  enumMember = this.RULE("enumMember", () => {
    this.CONSUME(Kw_enum);
    this.OPTION(() => this.CONSUME(Kw_def));
    this.OPTION2(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.CONSUME(Multiplicity));
  ...
  /** `abstract connection def CapabilityToGoalDerivation { … }` (CP:79) and
  ...
  connectionMember = this.RULE("connectionMember", () => {
    this.OPTION(() => this.CONSUME(Kw_abstract));
    this.CONSUME(Kw_connection);
    this.OPTION2(() => this.CONSUME(Kw_def));
    this.OPTION3(() => this.SUBRULE(this.shortName));
    this.OPTION4(() => this.CONSUME2(NameToken));
    this.OPTION5(() => this.CONSUME(Multiplicity));
    this.OPTION6(() => this.SUBRULE(this.typedTail));
    this.OPTION7(() => {
      this.CONSUME(Kw_connect);
      this.SUBRULE2(this.qualifiedName);
      this.CONSUME2(Kw_to);
    ...
    this.OPTION8(() => this.SUBRULE2(this.postBodyTail));
  });
  /** `calc <ln> naturalLogarithm { in x: DataValue[1]; return : DataValue[1]; }`
   *  (QU:79) — calc definition with a short name; parameters are the existing
   *  `in`/`out` featureMembers and the result is the new returnMember. Also
   *  accepts the SysML v2 usage form `calc name : ReturnType;` (and optional
   *  `:> S` specializations) via the shared typedTail. */
  calcMember = this.RULE("calcMember", () => {
    this.CONSUME(Kw_calc);
    this.OPTION(() => this.CONSUME(Kw_def));
    this.OPTION2(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.SUBRULE(this.typedTail));
    this.OR([
      { ALT: () => this.body() },
      { ALT: () => this.CONSUME2(Semicolon) }
    ]);
  });
  /** `view RequirementsTableView { … }` (VW:10) — a view definition or
   *  usage sharing the partMember shape. The fixture body holds only
   *  skipped line comments, i.e. an empty member list. */
  viewMember = this.RULE("viewMember", () => {
  ...
  /** `return : DataValue[1];` (QU:79) — the result clause of a calc body;
   *  Apollo D3 extends it with `:> specialization` and an optional
   *  `= valueExpression` assignment (`return deltaV :> ISQ::speed = (…);`).
   *  `Kw_return [name] [mult] (: type | :> spec) [mult]? (= expr)? ;` — the
   *  fixture omits the name in `return :> ISQ::power = …` and folds the
   *  multiplicity after the type. */
  returnMember = this.RULE("returnMember", () => {
    ...
    this.OPTION4(() => {
      this.CONSUME2(Equals);
      this.SUBRULE3(this.valueExpression);
    });
    this.CONSUME2(Semicolon);
  });
  // -------------------------------------------------------------------------
  // Apollo 11 work item D + D11/D12/D13 one-off members
  // -------------------------------------------------------------------------
  /** `part :>> spaceSuits[2];` / `part :>> spacecraft { … }` (Apollo D13 —
   *  bare part REDEFINITION members inside timeline/snapshot bodies; the
   *  name after `:>>` redefines a feature of the enclosing part). The member
   *  OR GATEs this alternative on `part` immediately followed by `:>>`. */
  partRedefMember = this.RULE("partRedefMember", () => {
    this.CONSUME(Kw_part);
    this.CONSUME(ColonGtGt);
    this.CONSUME2(NameToken);
    this.OPTION(() => this.CONSUME(Multiplicity));
   ...
   *  (Apollo D2). The `by` target is a full qualified name (dot chain). */
  satisfyMember = this.RULE("satisfyMember", () => {
    this.CONSUME(Kw_satisfy);
    this.SUBRULE(this.qualifiedName);
    this.CONSUME(Kw_by);
    this.SUBRULE2(this.qualifiedName);
  ...
  /** `analysis def SystemPowerAnalysis { … }` / `analysis X : SystemPowerAnalysis
   *  { … }` (Apollo D3) — mirrors calcMember (definition or usage, typed tail). */
  analysisMember = this.RULE("analysisMember", () => {
    this.CONSUME(Kw_analysis);
    this.OPTION(() => this.CONSUME(Kw_def));
    this.OPTION2(() => this.SUBRULE(this.shortName));
    this.CONSUME2(NameToken);
    this.OPTION3(() => this.SUBRULE(this.typedTail));
  ...
  /** `comment source /* … *​/` / `comment cost /* … *​/` (Apollo D7) — a
   *  comment member with an OPTIONAL designator (the model uses `source` and
   *  `cost`; a general NameToken keeps both without a `Kw_source` keyword —
   *  see the lexer group comment). */
  commentMember = this.RULE("commentMember", () => {
    this.CONSUME(Kw_comment);
    this.OPTION(() => this.CONSUME(NameToken));
    this.CONSUME2(BlockComment);
  });
  /** `require constraint { … }` (Apollo D11) — a requirement-frame constraint
   *  member with NO trailing semicolon (`require constraint {
   *  crewInjuryCount <= maxAcceptableInjuries }` followed directly by the
   *  next member). */
  requireMember = this.RULE("requireMember", () => {
    this.CONSUME(Kw_require);
    this.SUBRULE(this.constraintClause);
  });
  /** `constraint { valueExpression (;)? … }` — shared by `assert constraint`
   *  and `require constraint`. The body is a sequence of value expressions
   *  with optional semicolons (the fixtures mix `powerMargin > 0[W]`,
   *  `overallMissionSuccess = true;` and multi-line `and`-chains). */
  constraintClause = this.RULE("constraintClause", () => {
    this.CONSUME(Kw_constraint);
    this.CONSUME(LBrace);
    this.MANY(() => {
      this.OR([
        // docMember/blockComment MUST come before valueExpression: the lexer
        // treats keywords as valid names, so `doc` would otherwise be
        // swallowed as a name expression (and bare `/* … */` comments too).
        { ALT: () => this.SUBRULE(this.docMember) },
        { ALT: () => this.SUBRULE(this.blockComment) },
  ...
  /** `timeslice crewIngress { … }` (Apollo D13) — a timeline block; body
   *  members flow through the shared `member` rule (assert/snapshot/part
   *  redefinitions). Always has a body in the fixtures. */
  timesliceMember = this.RULE("timesliceMember", () => {
    this.CONSUME(Kw_timeslice);
    this.CONSUME2(NameToken);
    this.body();
  });
  /** `then …` successor members inside state-action/timeline bodies: `then
   *  timeslice x { … }` (D13), `then action x : T;` and `then done;` (D8).
   *  The alternatives are disjoint on the token after Kw_then. NOTE: position
   *  is NOT validated — via the shared `member` rule this parses at any level
   *  (the D13 test pins a package-level `then timeslice …`); the fixtures use
   *  it only inside timeline/state bodies. */
  thenMember = this.RULE("thenMember", () => {
    this.CONSUME(Kw_then);
    this.OR([
      {
        ALT: () => this.SUBRULE(this.timesliceMember),
        GATE: () => this.LA(1).tokenType === Kw_timeslice
      },
      {
        ALT: () => this.SUBRULE(this.thenActionMember),
        GATE: () => this.LA(1).tokenType === Kw_action
      },
      {
        ALT: () => this.SUBRULE(this.thenDoneMember),
        GATE: () => this.LA(1).tokenType === Kw_done
      }
    ]);
  });
  /** `then action loadConsumablesAndPropellants : LoadConsumablesAndPropellants;`
   *  (D8 — the `then`-succession action form inside `do action` bodies). */
  thenActionMember = this.RULE("thenActionMember", () => {
    this.CONSUME(Kw_action);
    this.CONSUME2(NameToken);
    this.OPTION(() => {
      this.CONSUME(Colon);
  ...
  /** `then done;` (D8). */
  thenDoneMember = this.RULE("thenDoneMember", () => {
    this.CONSUME(Kw_done);
    this.CONSUME(Semicolon);
  });
  /** `first start;` (D8 — the `first`-succession item inside `do action`
   *  bodies; `start` is the Kw_start keyword, consumed as a NameToken).
   *  NOTE: like thenMember, position is NOT validated — the shared `member`
   *  rule accepts it at any nesting level; the fixtures only use it in
   *  `do action` bodies. */
  firstMember = this.RULE("firstMember", () => {
    this.CONSUME(Kw_first);
    this.SUBRULE(this.qualifiedName);
    this.CONSUME(Semicolon);
  });
  /** `do action prepareForMissionPhaseOperations { … }` (D8) — the
   *  do-prefixed action member inside state definition bodies; its body
   *  flows through the shared `member` rule. */
  doMember = this.RULE("doMember", () => {
    this.CONSUME(Kw_do);
    this.CONSUME2(Kw_action);
    this.CONSUME3(NameToken);
    this.body();
  });
  /** `snapshot atIngress { … }` / `snapshot missionSystemAtIngress :>
   *  apollo11MissionSystem { … }` / `snapshot groundSystemAtIngress :> context
   *  : Apollo11MissionContext { … }` (D13) — an optional `:> spec` and an
   *  optional `: Type` tail before the body. */
  snapshotMember = this.RULE("snapshotMember", () => {
    this.CONSUME(Kw_snapshot);
    this.CONSUME2(NameToken);
    this.OPTION(() => {
      this.CONSUME(ColonGt);
      this.SUBRULE(this.qualifiedName);
   ...
   *  { … }` / `transition first initial then preparation;` (MissionPackage
   *  state machines inside the exhibit body). The `accept` trigger and the
   *  trailing body are optional; the target may be a plain name (`final` is
   *  NOT a keyword — it stays an Identifier, so no keyword-as-name risk). */
  transitionMember = this.RULE("transitionMember", () => {
    this.CONSUME(Kw_transition);
    this.CONSUME2(Kw_first);
    this.SUBRULE(this.qualifiedName);
    this.OPTION(() => {
      this.CONSUME(Kw_accept);
      this.SUBRULE2(this.qualifiedName);
    });
    this.CONSUME(Kw_then);
    this.CONSUME3(NameToken);
  ...
  /** `end source : StagingPort;` / `end target : ~StagingPort;` (D12,
   *  interface def bodies) / `end capa ::> programmaticAndPublicAffairsManagement;`
   *  (MissionPackage connection bodies). */
  endMember = this.RULE("endMember", () => {
    this.CONSUME(Kw_end);
    this.CONSUME2(NameToken);
    this.OR2([
      {
        ALT: () => {
          this.CONSUME(Colon);
          this.OPTION(() => this.CONSUME(Tilde));
          this.SUBRULE(this.qualifiedName);
        },
      ...
      {
        ALT: () => {
          this.CONSUME(ColonColonGt);
          this.SUBRULE2(this.qualifiedName);
        },
        GATE: () => this.LA(1).tokenType === ColonColonGt
      }
    ]);
    this.CONSUME2(Semicolon);
  });
  /** Bare local definition/assignment members inside analysis and calc
   *  bodies: `launchVehicle : SaturnV = apollo11Mission…;`,
   *  `sic = launchVehicle.stage1;`, `fullStack = (sii, sivb, …);` (D3). No
   *  other member rule starts with a plain NameToken, so the member OR GATE
   *  is a formality. */
  localMember = this.RULE("localMember", () => {
    this.CONSUME(NameToken);
    this.OPTION(() => {
      this.CONSUME(Colon);
      this.SUBRULE(this.qualifiedName);
  ...
  /** Post-body specialization tail (Apollo D4): `:> S (, S)* ;` or
   *  `:>> S ;` directly after a member's body — `part 'as-201' : Mission {
   *  … } :> missions;`, `item concern1 : Concern { … } :> concerns;`,
   *  `exhibit state apollo11Phases { … } :>> phases;`,
   *  `connection : CapabilityToGoalDerivation { … } :> capabilityToGoals;`.
   *  RESTRICTION (deliberate, fixture-proven): only bare NameTokens are
   *  accepted after the marker — a QUALIFIED post-body tail (`:> Lib::name;`)
   *  is a parse error. Every post-body tail in the fixtures is a simple name
   *  (and often a bare redefinition target), so the narrow form is kept; the
   *  plan's no-over-generalization clause would need fixture evidence before
   *  widening this. */
  postBodyTail = this.RULE("postBodyTail", () => {
    this.OR([
      { ALT: () => this.CONSUME(ColonGt) },
      { ALT: () => this.CONSUME(ColonGtGt) }
    ]);
  ...
  // -------------------------------------------------------------------------
  // Value expressions (minimal acceptance)
  // -------------------------------------------------------------------------
  /**
   * A value in a `= ...` position: `operand (op operand)*` with flat
   * (precedence-free) consumption of the arithmetic, comparison, logical and
   * navigation operators (`+ - / ^ * > >= < <= = == and istype ->`; Apollo
   * D3/D11 extend the original arithmetic set for constraint bodies —
   * `powerMargin > 0[W]`, `(a == b) and not c` — and calc returns —
   * `system.subparts->select { … }`). Parenthesized, call and arrow-block
   * operands are accepted, so arithmetic/comparison-heavy bodies lex/parse
   * without crashing; the value text is reconstructed verbatim-ish by the
   * AST builder. No precedence / evaluation semantics.
   */
  valueExpression = this.RULE("valueExpression", () => {
    this.SUBRULE(this.valueOperand);
    this.MANY(() => {
      this.SUBRULE(this.valueOperator);
      this.SUBRULE2(this.valueOperand);
    });
  });
  /** Flat binary operator consumed between value operands (Apollo D3/D11).
   *  `>=`, `<=`, `==` are the two-token sequences (RAngle Equals / LAngle
   *  Equals / Equals Equals) glued by renderValue; they live in the
   *  valueComparison subrule below (each rule stays under Chevrotain's per
   *  rule DSL occurrence limits). First tokens are pairwise disjoint, so the
   *  OR needs no GATEs. */
  valueOperator = this.RULE("valueOperator", () => {
    this.OR([
      { ALT: () => this.CONSUME(Plus) },
      { ALT: () => this.CONSUME2(Minus) },
      { ALT: () => this.CONSUME3(Slash) },
      { ALT: () => this.CONSUME4(Caret) },
      { ALT: () => this.CONSUME5(Star) },
      { ALT: () => this.SUBRULE(this.valueComparison) },
      { ALT: () => this.CONSUME6(Kw_and) },
      { ALT: () => this.CONSUME7(Kw_istype) },
      { ALT: () => this.CONSUME8(Arrow) }
      // `->`
    ]);
  });
  /** `>`, `>=`, `<`, `<=`, `=`, `==` comparison/equality operator (the
   *  `>=`/`<=`/`==` two-token sequences). The bare `<` is kept as the natural
   *  symmetric half of `>` — fixture-PROVEN, not a symmetry gamble:
   *  TechnicalRequirementsPackage.sysml:609 has
   *  `(actualInternalTemperatureRise < maxInternalTemperatureRise)` inside a
   *  `require constraint` body (pinned in test/apollo-d.test.ts). */
  valueComparison = this.RULE("valueComparison", () => {
    this.OR([
      {
        ALT: () => {
          this.CONSUME(RAngle);
      ...
      },
      {
        ALT: () => {
          ...
          this.OPTION2(() => this.CONSUME2(Equals));
        }
      },
      {
        ALT: () => {
          this.CONSUME3(Equals);
          this.OPTION3(() => this.CONSUME4(Equals));
        }
      }
    ]);
  });
  /** A single operand: zero or more unary prefixes — `-` (e.g. `-a`, `-1`,
   *  `- (a + b)`) and `not` (Apollo constraint bodies:
   *  `not wasteContaminationDetected`) — then a value atom, an arrow block
   *  (`select { … }`, D3) or a parenthesized sub-expression such as `(a + b)`
   *  or `(a, b, c)`, optionally followed by a trailing unit/multiplicity
   *  bracket (`= 0 [W]`, `= 9.80665 [m/s^2]`). The prefixes are ONE repeating
   *  group (SysML v2 BNF `prefixOperator*`), so `- not x`, `not not x` and
   *  mixed prefixes all parse instead of being limited to one of each; the
   *  first tokens (Minus/Kw_not) stay disjoint from every following operand
   *  start, so the lookahead is unchanged. */
  valueOperand = this.RULE("valueOperand", () => {
    this.MANY(() => {
      this.OR2([
    ...
    this.OR([
      {
        ALT: () => {
          ...
          this.OPTION3(() => this.SUBRULE(this.callTail));
          this.OPTION4(() => this.CONSUME(Multiplicity));
        },
        GATE: () => !(isPlainName(this.LA(1).tokenType) && this.LA(2).tokenType === LBrace)
      },
      {
        // `->select { … }` arrow block (D3): the name and `{ … }` body glue
        // to the preceding `->` operator; the block body holds feature-style
        // parameter declarations (`in sys : Part;`) and value expressions
        // (`sys istype PowerProvider`)
        ALT: () => this.SUBRULE2(this.arrowBlock),
        GATE: () => isPlainName(this.LA(1).tokenType) && this.LA(2).tokenType === LBrace
      },
      {
        // parenthesized sub-expression (also a comma list: `fullStack =
        // (sii, sivb, …)`)
        ALT: () => this.SUBRULE3(this.parenExpr),
        GATE: () => this.LA(1).tokenType === LParen
      }
    ]);
  });
  /** `name ( expr, expr, … )` call tail — `sum(a.b)`, `ln(m0 / mf)`, `sum()`.
   *  Parens may be empty (the `->sum()` of the D3 calc returns). */
  callTail = this.RULE("callTail", () => {
    this.CONSUME(LParen);
    this.OPTION(() => {
      this.SUBRULE(this.valueExpression);
      this.MANY(() => {
  ...
  /** `name { featureMember | valueExpression }` arrow block body (D3): the
   *  `select { in sys : Part; sys istype PowerProvider }` lambda of the calc
   *  return values. First sets are disjoint (Kw_in/Kw_out/Kw_inout vs value
   *  operand starts). */
  arrowBlock = this.RULE("arrowBlock", () => {
    this.CONSUME(NameToken);
  ...
  /** `( valueExpression (, valueExpression)* )` group / tuple. */
  ...
  /** A bare value atom: a qualified name, a number literal (`9.80665`,
   *  `100`, `1`, `3.2E-14`), or a string literal (`"All propulsive stages …"`).
   *  All three first tokens are disjoint (NameToken vs Number vs
   *  StringLiteral), so a lookahead of 1 suffices and maxLookahead stays 4. */
...
function isPlainName(tt) {
  return tt === Identifier || tt === QuotedName;
}
function isRefKind(tt) {
  return tt === Kw_part || tt === Kw_item || tt === Kw_requirement || tt === Kw_attribute || tt === Kw_port || tt === Kw_action;
}
function createParser() {
  return new SysmlParser();
}
...
function all(node, key) {
  return child(node)[key] ?? [];
}
function first(node, key) {
  return all(node, key)[0];
}
function image(node, key) {
  const tok = first(node, key);
  return tok?.image;
}
function tokens(node, key) {
  return all(node, key);
}
function rules(node, key) {
  return all(node, key);
}
function qn(node) {
  if (!node) return "";
  const c = child(node);
  const nameTokens = tokens(node, "NameToken");
  let result = unwrapName(nameTokens[0]?.image ?? "");
  const seps = [];
  const sepCount = (c.ColonColon?.length ?? 0) + (c.Dot?.length ?? 0);
  for (let i = 0; i < sepCount; i++) {
    const colonColon = c.ColonColon?.[i]?.image;
    const dot = c.Dot?.[i]?.image;
    seps.push(colonColon ?? dot ?? ".");
  }
  for (let i = 0; i < seps.length; i++) {
    const star = c.Star?.[i]?.image;
    const starStar = c.StarStar?.[i]?.image;
    result += seps[i] + (star ?? starStar ?? unwrapName(nameTokens[i + 1]?.image ?? ""));
  }
  return result;
}
...
function firstOffset(node) {
  const tok = child(node).NameToken?.[0];
  if (tok) return tok.startOffset;
  for (const key of Object.keys(child(node))) {
    const first2 = child(node)[key][0];
    if (first2 && typeof first2 === "object" && "startOffset" in first2) {
      return first2.startOffset;
    }
  }
  return 0;
}
function typeAndSpecs(node) {
  if (!node) return { type: void 0, specializations: void 0 };
  const startOf = firstOffset;
  const qns = [...rules(node, "qualifiedName")].sort(
    (a, b) => startOf(a) - startOf(b)
  );
  const colonTok = tokens(node, "Colon")[0];
  if (!colonTok) {
    return {
      type: void 0,
      specializations: qns.length ? qns.map(qn) : void 0
    };
  }
  const markers = [
    ...child(node).ColonGt ?? [],
    ...child(node).ColonGtGt ?? []
  ].sort((a, b) => a.startOffset - b.startOffset);
  const firstMarker = markers.find((m) => m.startOffset > colonTok.startOffset);
  const afterColon = qns.filter((q) => startOf(q) > colonTok.startOffset);
  const types = afterColon.filter(
    (q) => !firstMarker || startOf(q) < firstMarker.startOffset
  );
  const specializationNames = qns.filter((q) => !types.includes(q)).map(qn);
  return {
    type: types.length ? types.map(qn).join(", ") : void 0,
    // multi-type lists only (`: A, B`): single-type nodes keep their exact
    // previous shape (`type` alone), so no existing consumer changes behavior
    types: types.length > 1 ? types.map(qn) : void 0,
    specializations: specializationNames.length ? specializationNames : void 0
  };
}
function findValueExpr(node) {
  if (!node) return void 0;
  const direct = rules(node, "valueExpression")[0];
  if (direct) return direct;
  const assign = rules(node, "attrAssign")[0];
  return assign ? rules(assign, "valueExpression")[0] : void 0;
}
function shortNameOf(node) {
  const shortNode = rules(node, "shortName")[0];
  return shortNode ? unwrapName(image(shortNode, "NameToken")) : void 0;
}
function membersOf(node) {
  return rules(node, "member").map(buildMember).filter((m) => m !== void 0);
}
function postSpecsOf(node) {
  const post = rules(node, "postBodyTail")[0];
  if (!post) return [];
  return tokens(post, "NameToken").map((t) => unwrapName(t.image));
}
function constraintTextOf(node) {
  const clause = rules(node, "constraintClause")[0];
  if (!clause) return "";
  return rules(clause, "valueExpression").map((e) => renderValue(e)).filter((s) => s !== void 0).join("; ");
}
function constraintDocsOf(node) {
  const clause = rules(node, "constraintClause")[0];
  if (!clause) return void 0;
  const docs = [
    ...rules(clause, "docMember"),
    ...rules(clause, "blockComment")
  ].sort((a, b) => firstOffset(a) - firstOffset(b)).map(buildDoc);
  return docs.length ? docs : void 0;
}
function buildTimeslice(node) {
  return {
    kind: "timeslice",
    name: unwrapName(image(node, "NameToken") ?? ""),
    members: membersOf(node)
  };
}
function buildAttributeUsual(node) {
  const tail = rules(node, "typedTail")[0];
  const { type, specializations } = typeAndSpecs(tail);
  const vod = rules(node, "attrValueOrDefault")[0];
  const hasDefault = vod ? all(vod, "Kw_default").length > 0 : false;
  return {
    kind: "attribute",
    name: unwrapName(image(node, "NameToken") ?? ""),
    shortName: shortNameOf(node),
    // a multiplicity may sit right after the name (direct child) or after a
    // `: Type` in the shared tail subrule (`CurrencyValue[1]`, `CurrencyValue[*]`)
    multiplicity: image(node, "Multiplicity") ?? (tail ? image(tail, "Multiplicity") : void 0),
    // legacy: a `:> Unit`-only attribute reported its single target as `type`
    // (e.g. `attribute mass :> ISQ::mass;`); keep that while also exposing
    // the specialization list
    type: type ?? specializations?.[0],
    specializations,
    nonunique: tail && all(tail, "Kw_nonunique").length > 0 ? true : void 0,
    value: hasDefault ? void 0 : renderValue(findValueExpr(vod)),
    defaultValue: hasDefault ? renderValue(findValueExpr(vod)) : void 0,
    members: membersOf(node)
  };
}
function buildAttributeRedef(node) {
  return {
    kind: "attribute",
    isRedefinition: true,
    name: unwrapName(image(node, "NameToken") ?? ""),
    multiplicity: image(node, "Multiplicity"),
    type: all(node, "Colon").length > 0 ? qn(rules(node, "qualifiedName")[0]) : void 0,
    value: renderValue(findValueExpr(rules(node, "attrAssign")[0])),
    members: membersOf(node)
  };
}
function buildAttributeBare(node) {
  return {
    kind: "attribute",
    isRedefinition: true,
    name: unwrapName(image(node, "NameToken") ?? ""),
    // `:>> name : T` (bare redefinition with type, QU:34) — the type is
    // the qualifiedName that follows the `:` token
    type: all(node, "Colon").length > 0 ? qn(rules(node, "qualifiedName")[0]) : void 0,
    multiplicity: image(node, "Multiplicity"),
    value: renderValue(findValueExpr(node)),
    members: membersOf(node)
  };
}
function buildAttributeDef(node) {
  const { type, specializations } = typeAndSpecs(node);
  return {
    kind: "attribute",
    name: unwrapName(image(node, "NameToken") ?? ""),
    type: type ?? specializations?.[0],
...
function buildDoc(node) {
  return { kind: "doc", text: stripComment(image(node, "BlockComment") ?? "") };
}
function buildProperties(node) {
  return rules(node, "metadataProperty").map((p) => ({
    key: image(p, "NameToken") ?? "",
    // the value is either a double-quoted string literal (@Rationale {
    // text = "…"; }) rendered verbatim (quotes included) or a qualified
    // name reference. The two are disjoint CST children, so this is exact.
    value: image(p, "StringLiteral") ?? qn(rules(p, "qualifiedName")[0])
  }));
}
function buildTuple(node) {
  if (!node) return [];
  return rules(node, "qualifiedName").map(qn);
}
function unwrapMember(node) {
  if (node.name !== "member") return node;
  for (const key of Object.keys(child(node))) {
    const inner = child(node)[key][0];
    if (inner && typeof inner === "object" && "children" in inner) {
      return inner;
    }
  }
  return node;
...
function buildMember(node) {
  node = unwrapMember(node);
  switch (node.name) {
    case "blockComment":
      return buildDoc(node);
    case "docMember":
      return buildDoc(node);
    case "importMember": {
      const visibility = image(node, "Kw_private") ?? image(node, "Kw_public");
      return {
        kind: "import",
        visibility,
        target: qn(rules(node, "qualifiedName")[0])
      };
    }
    case "metadataMember":
    case "atMetadata": {
      return {
        kind: "metadata",
        syntax: node.name === "atMetadata" ? "annotation" : "metadata",
        name: image(node, "NameToken") ?? "",
        properties: buildProperties(node)
      };
    }
    case "packageMember": {
      const hasShortName = all(node, "LAngle").length > 0;
      const nameTokens = tokens(node, "NameToken");
      return {
        kind: "package",
        // present only for `library package` declarations, so plain packages
        // keep their exact previous shape
        isLibrary: all(node, "Kw_library").length > 0 ? true : void 0,
        name: unwrapName(nameTokens[hasShortName ? 1 : 0]?.image ?? ""),
        shortName: hasShortName ? unwrapName(nameTokens[0]?.image) : void 0,
        members: rules(node, "member").map(buildMember).filter((m) => m !== void 0)
      };
    }
    case "occurrenceMember": {
      const hasShortName = all(node, "LAngle").length > 0;
      const nameTokens = tokens(node, "NameToken");
      const qns = rules(node, "qualifiedName");
      return {
        kind: "occurrence",
        isDefinition: all(node, "Kw_def").length > 0,
        shortName: hasShortName ? unwrapName(nameTokens[0]?.image) : void 0,
        name: unwrapName(nameTokens[hasShortName ? 1 : 0]?.image ?? ""),
        type: qn(qns[0]) || void 0,
        multiplicity: image(node, "Multiplicity"),
        members: membersOf(node)
      };
    }
    case "actionMember": {
      const tail = rules(node, "actionTail")[0];
      const { type, specializations } = typeAndSpecs(tail);
      return {
        kind: "action",
        isAbstract: all(node, "Kw_abstract").length > 0 ? true : void 0,
        isDefinition: all(node, "Kw_def").length > 0,
        shortName: shortNameOf(node),
        name: unwrapName(image(node, "NameToken") ?? ""),
        multiplicity: image(node, "Multiplicity"),
    ...
    case "partMember": {
      const tail = rules(node, "typedTail")[0];
      const { type, types, specializations } = typeAndSpecs(tail);
      const vod = rules(node, "attrValueOrDefault")[0];
      const hasDefault = vod ? all(vod, "Kw_default").length > 0 : false;
      const post = postSpecsOf(node);
      const preSpecs = specializations ?? [];
      return {
        kind: "part",
        isDefinition: all(node, "Kw_def").length > 0,
        isAbstract: all(node, "Kw_abstract").length > 0 ? true : void 0,
        isIndividual: all(node, "Kw_individual").length > 0 ? true : void 0,
        shortName: shortNameOf(node),
        // name multiplicity (direct child) or type multiplicity (typedTail)
        multiplicity: image(node, "Multiplicity") ?? (tail ? image(tail, "Multiplicity") : void 0),
        ordered: all(node, "Kw_ordered").length > 0 ? true : void 0,
        name: unwrapName(image(node, "NameToken") ?? ""),
        type,
        // multi-type alias (`: A, B`): see the PartNode `types` comment
        types,
        // the pre-body `:> …` tail merges with the post-body `:> …` tail (D4)
        specializations: preSpecs.length || post.length ? [...preSpecs, ...post] : void 0,
        defaultValue: hasDefault ? renderValue(findValueExpr(vod)) : void 0,
        members: membersOf(node)
      };
    }
    case "partRedefMember": {
      const tupleVal = buildTuple(first(node, "tuple"));
      return {
        kind: "part",
        isDefinition: false,
        isRedefinition: true,
        name: unwrapName(image(node, "NameToken") ?? ""),
        multiplicity: image(node, "Multiplicity"),
        value: tupleVal.length ? tupleVal : void 0,
        members: membersOf(node)
      };
    }
    case "partMemberWrapper": {
      const inner = rules(node, "partMember")[0];
      if (!inner) return void 0;
      const built = buildMember(inner);
      if (!built || built.kind !== "part") return void 0;
      const post = postSpecsOf(node);
      if (post.length) {
        return {
          ...built,
          specializations: [...built.specializations ?? [], ...post]
        };
      }
      return built;
    }
    ...
    case "portMember": {
      const typeQn = rules(node, "qualifiedName")[0];
      return {
        kind: "port",
        isDefinition: all(node, "Kw_def").length > 0,
        name: unwrapName(image(node, "NameToken") ?? ""),
        // no type for `port def X { … }`; a leading `~` (conjugation) stays
        // in the rendered type string (one literal, no separate flag)
        type: typeQn ? (all(node, "Tilde").length > 0 ? "~" : "") + qn(typeQn) : void 0,
        members: rules(node, "member").map(buildMember).filter((m) => m !== void 0)
      };
    }
    ...
    case "abstractInterfaceDefMember": {
      const inner = rules(node, "interfaceDefMember")[0];
      if (!inner) return void 0;
      const built = buildMember(inner);
      if (!built || built.kind !== "interface") return void 0;
      return { ...built, isAbstract: true };
    }
    case "interfaceDefMember": {
      return {
        kind: "interface",
        isDefinition: true,
        name: unwrapName(image(node, "NameToken") ?? ""),
    ...
    case "allocationMember": {
      const qns = rules(node, "qualifiedName");
      return {
        kind: "allocation",
        type: qn(qns[0]),
        source: qn(qns[1]),
        target: unwrapName(image(node, "NameToken") ?? "")
      };
    }
    case "dependencyMember": {
      return {
        kind: "dependency",
        // the source is the single direct NameToken after Kw_dependency
        source: unwrapName(image(node, "NameToken") ?? ""),
        target: qn(rules(node, "qualifiedName")[0])
      };
    }
    case "annotatedDependencyMember": {
      const dep = rules(node, "dependencyMember")[0];
      if (!dep) return void 0;
      const built = buildMember(dep);
      if (!built || built.kind !== "dependency") return void 0;
      return { ...built, annotation: unwrapName(image(node, "NameToken") ?? "") };
    }
    case "requirementMember": {
      const id = shortNameOf(node);
      const tail = rules(node, "typedTail")[0];
      const { type, specializations } = typeAndSpecs(tail);
      const post = postSpecsOf(node);
      const preSpecs = specializations ?? [];
      return {
        kind: "requirement",
        isDefinition: all(node, "Kw_def").length > 0 ? true : void 0,
        id,
        // the `shortName` subrule eats the `<...>` tokens, so the direct
        // NameToken is always the real name
        name: unwrapName(image(node, "NameToken") ?? ""),
        type,
        // name multiplicity (direct child) or type multiplicity (typedTail)
        multiplicity: image(node, "Multiplicity") ?? (tail ? image(tail, "Multiplicity") : void 0),
    ...
    case "subjectMember": {
      return {
        kind: "subject",
        name: unwrapName(image(node, "NameToken") ?? ""),
        type: qn(rules(node, "qualifiedName")[0])
      };
    }
    case "assertMember": {
      if (all(node, "Kw_satisfy").length > 0) {
        return {
          kind: "assert",
          keyword: "satisfy",
          target: unwrapName(image(node, "NameToken") ?? "")
      ...
      return {
        ...
        keyword: "constraint",
        target: "",
        constraint: constraintTextOf(node)
      };
    }
    case "flowMember": {
      const qns = rules(node, "qualifiedName");
      const nameTokens = tokens(node, "NameToken");
      if (all(node, "Colon").length > 0) {
        return {
          kind: "flow",
          name: unwrapName(nameTokens[0]?.image ?? ""),
          type: unwrapName(nameTokens[1]?.image ?? ""),
          from: qn(qns[0]),
          to: qn(qns[1])
        };
      }
      return { kind: "flow", from: qn(qns[0]), to: qn(qns[1]) };
    }
    case "successionMember": {
      const qns = rules(node, "qualifiedName");
      const from = all(node, "Kw_start").length > 0 ? "start" : qn(qns[0]);
      const to = all(node, "Kw_done").length > 0 ? "done" : qn(qns[all(node, "Kw_start").length > 0 ? 0 : 1]);
    ...
    case "performMember": {
      ...
      return {
        kind: "perform",
        target: qn(qns[0]),
        type: all(node, "Colon").length > 0 ? qn(qns[1]) : void 0,
        redefinition: all(node, "ColonGtGt").length > 0 ? qn(qns[qns.length - 1]) : void 0
      };
    }
    case "refMember": {
      const nameTokens = tokens(node, "NameToken");
      const isRedef = all(node, "ColonGtGt").length > 0;
      if (isRedef) {
        return {
          kind: "ref",
          keyword: unwrapName(nameTokens[0]?.image ?? ""),
          name: unwrapName(nameTokens[1]?.image ?? ""),
          value: buildTuple(rules(node, "tuple")[0])
        };
      }
      const { type, specializations } = typeAndSpecs(node);
      return {
    ...
    case "attributeMember": {
      const visibility = all(node, "Kw_private").length > 0 ? "private" : void 0;
      const usual = rules(node, "attributeUsual")[0];
      if (usual) return { ...buildAttributeUsual(usual), visibility };
      const redef = rules(node, "attributeRedef")[0];
      if (redef) return { ...buildAttributeRedef(redef), visibility };
      const bare = rules(node, "attributeBareRedef")[0];
      if (bare) return { ...buildAttributeBare(bare), visibility };
      const def = rules(node, "attributeDef")[0];
      if (def) return { ...buildAttributeDef(def), visibility };
      const subset = rules(node, "attributeBareSubset")[0];
      if (subset) return { ...buildAttributeBare(subset), visibility };
      return void 0;
    }
    case "featureMember": {
      const { type, specializations } = typeAndSpecs(node);
      const nameTok = image(node, "NameToken");
      const tupleVal = buildTuple(first(node, "tuple"));
      const assignExpr = findValueExpr(node);
      return {
        kind: "feature",
        direction: image(node, "Kw_in") ? "in" : image(node, "Kw_out") ? "out" : "inout",
        name: nameTok ? unwrapName(nameTok) : void 0,
        multiplicity: image(node, "Multiplicity"),
        type,
        specializations,
        value: tupleVal.length ? tupleVal : void 0,
        assign: assignExpr && !tupleVal.length ? renderValue(assignExpr) : void 0
      };
    }
    case "stateMember": {
      const tail = rules(node, "typedTail")[0];
    ...
    case "exhibitMember": {
      ...
      return {
        ...
        target: qn(qns[0]),
        type: all(node, "Colon").length > 0 ? qn(qns[1]) : void 0,
        specializations: post.length ? post : void 0,
        members: membersOf(node)
      };
    }
    case "enumMember": {
    ...
    case "connectionMember": {
      ...
      const preSpecs = specializations ?? [];
      const qns = rules(node, "qualifiedName");
      const connectTok = tokens(node, "Kw_connect")[0];
      let from;
      let to;
      if (connectTok) {
        const connectQns = qns.filter((q) => firstOffset(q) > connectTok.startOffset).map(qn);
        from = connectQns[0];
        to = connectQns[1];
      }
      const nameTok = image(node, "NameToken");
    ...
    case "satisfyMember": {
      const qns = rules(node, "qualifiedName");
      return { kind: "satisfy", target: qn(qns[0]), by: qn(qns[1]) };
    }
    case "analysisMember": {
      const tail = rules(node, "typedTail")[0];
      const { type, specializations } = typeAndSpecs(tail);
    ...
    case "commentMember": {
      const designator = image(node, "NameToken");
      return {
        kind: "comment",
        designator: designator ? unwrapName(designator) : void 0,
        text: stripComment(image(node, "BlockComment") ?? "")
      };
    }
    case "requireMember":
      return {
    ...
    case "firstMember":
      return { kind: "first", target: qn(rules(node, "qualifiedName")[0]) };
    case "thenMember": {
      const t = rules(node, "timesliceMember")[0];
      if (t) return { ...buildTimeslice(t), then: true };
      const a = rules(node, "thenActionMember")[0];
      if (a) {
        const qns = rules(a, "qualifiedName");
        return {
          kind: "then",
          action: unwrapName(image(a, "NameToken") ?? ""),
          type: all(a, "Colon").length > 0 ? qn(qns[0]) : void 0
        };
      }
      return { kind: "then", target: "done" };
    }
    case "timesliceMember":
      return buildTimeslice(node);
    case "snapshotMember": {
      const { type, specializations } = typeAndSpecs(node);
      return {
        kind: "snapshot",
    ...
    case "transitionMember": {
      ...
      return {
        kind: "transition",
        source: qn(qns[0]),
        trigger: all(node, "Kw_accept").length > 0 ? qn(qns[1]) : void 0,
        target: unwrapName(image(node, "NameToken") ?? ""),
        members: membersOf(node)
      };
    }
    case "endMember": {
      const qns = rules(node, "qualifiedName");
      const hasColon = all(node, "Colon").length > 0;
      return {
        kind: "end",
        name: unwrapName(image(node, "NameToken") ?? ""),
        type: hasColon ? (all(node, "Tilde").length > 0 ? "~" : "") + qn(qns[0]) : void 0,
        redefinition: all(node, "ColonColonGt").length > 0 ? qn(qns[0]) : void 0
      };
    }
    case "localMember": {
      const qns = rules(node, "qualifiedName");
      return {
        kind: "local",
        name: unwrapName(image(node, "NameToken") ?? ""),
        type: all(node, "Colon").length > 0 ? qn(qns[0]) : void 0,
        value: renderValue(rules(node, "valueExpression")[0]) ?? ""
      };
    }
    default:
      return void 0;
...
function renderValue(node) {
  ...
  const toks = [];
  const visit = (n) => {
    for (const key of Object.keys(child(n))) {
      for (const item of child(n)[key]) {
        if (typeof item === "object" && "image" in item) {
          toks.push(item);
        } else if (typeof item === "object" && "children" in item) {
          visit(item);
        }
      }
    }
  ...
  visit(node);
  toks.sort((a, b) => a.startOffset - b.startOffset);
  const unwrap = (s) => s.startsWith("'") && s.endsWith("'") ? s.slice(1, -1) : s;
  const isName = (s) => /^[A-Za-z_]/.test(s);
  const isKeywordOperator = (s) => s === "and" || s === "istype" || s === "not";
  const endsValue = (s) => /[A-Za-z0-9_)\]"']/.test(s);
  let out = "";
  let prev = "";
  let prevWasUnaryMinus = false;
  for (const tok of toks) {
    const cur = unwrap(tok.image);
    const unaryMinus = cur === "-" && !endsValue(prev);
    const attach = prev === "" || // first token: no leading space
    prevWasUnaryMinus || // operand glued to a unary `-` / `->` arrow
    prev === "." || prev === "::" || prev === "(" || cur === "." || cur === "::" || cur === ")" || cur === "," || cur === ";" || cur === "->" || // navigation arrows glue (Apollo D3: `subparts->select`)
    // multi-char comparison/equality operators glue their parts
    // (`a >= b`, `a <= b`, `a == b`; a bare `=`/`>`/`<` stays spaced)
    cur === "=" && (prev === ">" || prev === "<" || prev === "=") || // a `(` is part of a call/group only when it follows a name (call
    // syntax), `)` (chained call) or the start; after an operator it is
    // a separate operand, so `a / (b + c)` keeps the space. A keyword
    // operator (and/istype/not) is NOT a call head either: `a and (b)`
    // stays `and (b)`, only `sum(...)`/`f(...)` glue
    cur === "(" && (prev === ")" || isName(prev) && !isKeywordOperator(prev));
    out += (attach ? "" : " ") + cur;
    prev = cur;
    prevWasUnaryMinus = unaryMinus || cur === "->";
  }
  return out;
}
function unwrapName(raw) {
  if (raw === void 0) return "";
  if (raw.startsWith("'") && raw.endsWith("'")) return raw.slice(1, -1);
  return raw;
}
function buildModel(modelCst) {
  return {
    kind: "model",
    members: rules(modelCst, "member").map(buildMember).filter((m) => m !== void 0)
  };
}
...
// src/query.ts
function nameOf(m) {
  if ("name" in m && typeof m.name === "string" && m.name.length > 0) {
    return m.name;
  }
  return void 0;
}
...
function normalizeQualifiedName(qn2) {
  return qn2.split("::").map((s) => s.trim().replace(/^'(.*)'(\[\d+\])?$/, "$1$2")).join("::");
}
function buildIndex(model) {
  const all2 = [];
  const namedByKey = /* @__PURE__ */ new Map();
  const byId = /* @__PURE__ */ new Map();
  const childrenByParent = /* @__PURE__ */ new Map();
  const visit = (members, prefix, parentId) => {
    const seen = /* @__PURE__ */ new Map();
    for (const member of members) {
      const name = nameOf(member);
      const rawKey = name ?? `<${member.kind}>`;
      const count = seen.get(rawKey) ?? 0;
      seen.set(rawKey, count + 1);
      const rendered = name !== void 0 ? quoteSegment(name) : `<${member.kind}>`;
      const segment = count > 0 ? `${rendered}[${count + 1}]` : rendered;
      const segments = [...prefix, segment];
      const id = segments.join("::");
      const element = {
        id,
        qualifiedName: name !== void 0 ? id : void 0,
        parentId,
        kind: member.kind,
        name,
        member
      ...
      if (siblings !== void 0) siblings.push(element);
      else childrenByParent.set(parentId, [element]);
      if (name !== void 0) {
        namedByKey.set(normalizeQualifiedName(id), element);
      }
      if ("members" in member && Array.isArray(member.members)) {
        visit(member.members, segments, id);
      }
    }
  };
  visit(model?.members ?? [], [], void 0);
  return { all: all2, namedByKey, byId, childrenByParent };
}
function createModelIndex(result) {
  const { all: all2, namedByKey, byId, childrenByParent } = buildIndex(result.model);
  return {
    list(filter) {
      if (filter === void 0 || filter.kind === void 0) {
        return all2.slice();
      }
      const kinds = Array.isArray(filter.kind) ? filter.kind : [filter.kind];
      return all2.filter((el) => kinds.includes(el.kind));
    },
    get(qualifiedName) {
      const key = typeof qualifiedName === "string" ? qualifiedName : Array.isArray(qualifiedName) && qualifiedName.every((s) => typeof s === "string") ? qualifiedName.join("::") : void 0;
      return key !== void 0 ? namedByKey.get(normalizeQualifiedName(key)) : void 0;
    },
    byId(id) {
      return typeof id === "string" ? byId.get(id) : void 0;
    },
    children(parentId) {
...
// src/loader.ts
function parseDiagnostics(path, result) {
  const out = [];
  for (const err of result.lexerErrors) {
    out.push({
      severity: "error",
      path,
      message: `Lexer error at ${err.line}:${err.column} \u2014 ${err.message}`
    });
  }
  for (const err of result.parserErrors) {
    ...
    out.push({
      severity: "error",
      path,
      message: `Parser error at ${tok.line ?? "?"}:${tok.column ?? "?"} near "${tok.image}" \u2014 ${err.message}`
    });
  }
  return out;
}
function crashDiagnostic(path, thrown) {
  return {
    severity: "error",
    path,
    message: `Parser error \u2014 ${thrown instanceof Error ? thrown.message : String(thrown)}`
  };
}
function failedResult(path) {
  return {
    path,
    crashed: true,
    result: {
...
function recordOrigin(origin, member, path) {
  origin.set(member, path);
  if ("members" in member && Array.isArray(member.members)) {
    for (const m of member.members) recordOrigin(origin, m, path);
  }
}
function mergePackage(target, source) {
  const nested = /* @__PURE__ */ new Map();
  for (const m of target.members) {
    if (m.kind === "package") nested.set(m.name, m);
  }
  for (const m of source.members) {
    if (m.kind === "package") {
      const existing = nested.get(m.name);
      if (existing !== void 0) {
        mergePackage(existing, m);
        continue;
      }
      nested.set(m.name, m);
    }
...
function mergeFiles(origin, files) {
  const topLevel = [];
  const diagnostics = [];
  const byName = /* @__PURE__ */ new Map();
  const declaredIn = (indices) => [...new Set(indices.map((i) => origin.get(topLevel[i]) ?? "another file"))].join(", ");
  for (const file of files) {
    const path = file.path;
    for (const member of file.result.model.members) {
      recordOrigin(origin, member, path);
      const name = nameOf(member);
      if (member.kind === "package" && name !== void 0 && byName.has(name)) {
        const existing = topLevel[byName.get(name)[0]];
        if (existing.kind === "package") {
          mergePackage(existing, member);
        } else {
          diagnostics.push({
            severity: "error",
            path,
            message: `top-level package "${name}" collides with a ${existing.kind} member of the same name \u2014 both kept`
          });
          topLevel.push(member);
          byName.set(name, [...byName.get(name), topLevel.length - 1]);
        }
        continue;
      }
      const idx = topLevel.push(member) - 1;
      if (name !== void 0 && byName.has(name)) {
        const prior = byName.get(name);
        if (prior.some((i) => topLevel[i].kind === "package")) {
          diagnostics.push({
            severity: "error",
            path,
            message: `top-level ${member.kind} "${name}" collides with a package of the same name \u2014 both kept`
          });
        } else {
          diagnostics.push({
            severity: "error",
            path,
            message: `duplicate top-level ${member.kind} name "${name}" (also declared in ${declaredIn(prior)}) \u2014 both kept`
          });
        }
        byName.set(name, [...prior, idx]);
      } else if (name !== void 0) {
        byName.set(name, [idx]);
      }
    }
  }
  return { model: { kind: "model", members: topLevel }, diagnostics };
}
function byPath(a, b) {
  return a < b ? -1 : a > b ? 1 : 0;
}
function loadModel(files) {
  const origin = /* @__PURE__ */ new WeakMap();
  const results = [];
  const diagnostics = [];
  for (const { path, source } of [...files].sort((a, b) => byPath(a.path, b.path))) {
    let result;
    try {
      result = parseSysml(source);
    } catch (thrown) {
      diagnostics.push(crashDiagnostic(path, thrown));
      results.push(failedResult(path));
      continue;
    }
    results.push({ path, result });
    diagnostics.push(...parseDiagnostics(path, result));
  }
  const { model, diagnostics: mergeDiags } = mergeFiles(origin, results);
  diagnostics.push(...mergeDiags);
  return {
    model,
    files: results,
    originOf: (member) => origin.get(member),
    diagnostics,
...
function splitQualified(raw) {
  ...
  return { absolute, segments, wildcard };
}
function isContainer(m) {
  return "members" in m && Array.isArray(m.members);
}
function stripTilde(t) {
  return t.startsWith("~") ? t.slice(1) : t;
}
function typeOf(m) {
  const t = m.type;
  if (typeof t !== "string" || t.trim().length === 0) return void 0;
  return stripTilde(t);
}
function typeListOf(m) {
  const t = typeOf(m);
  return t === void 0 ? [] : t.split(", ").map(stripTilde);
}
function createWorkspaceIndex(result, opts) {
  const libraries = new Set(opts?.libraries ?? DEFAULT_LIBRARY_ROOTS);
  const base = createModelIndex(result);
  const memberToEl = /* @__PURE__ */ new WeakMap();
  for (const el of base.list()) memberToEl.set(el.member, el);
  const containers = /* @__PURE__ */ new Map();
  const allImports = [];
  const done = /* @__PURE__ */ new WeakSet();
  const rootOwn = /* @__PURE__ */ new Map();
  const rootNames = [];
  const rootImports = [];
  for (const el of base.list()) {
    if (el.parentId !== void 0) continue;
    const m = el.member;
    if (m.kind === "import") {
      rootImports.push(makeImportInfo(m, memberToEl.get(m)));
    } else {
      const n = nameOf(m);
      if (n !== void 0 && !rootOwn.has(n)) {
        rootOwn.set(n, el);
        rootNames.push(n);
      }
    }
  ...
  allImports.push(...rootImports);
  for (const el of base.list()) {
    if (!isContainer(el.member)) continue;
    const own = /* @__PURE__ */ new Map();
    const ownNames = [];
    const imports = [];
    for (const m of el.member.members) {
      if (m.kind === "import") {
        imports.push(makeImportInfo(m, memberToEl.get(m)));
      } else {
        const n = nameOf(m);
        if (n !== void 0 && !own.has(n)) {
          const me = memberToEl.get(m);
          if (me) {
            own.set(n, me);
            ownNames.push(n);
          }
    ...
    const ctx = { element: el, own, ownNames, imports };
    containers.set(el.id, ctx);
    allImports.push(...imports);
  }
  function makeImportInfo(m, element) {
    ...
    return {
      ...
      target,
      status: "unresolved",
      // provisional; corrected by resolveImport
      isWildcard: splitQualified(target).wildcard,
      owner: element?.parentId
    };
  }
  function ctxOf(el) {
    return el !== void 0 ? containers.get(el.id) : void 0;
  }
  function parentCtx(ctx) {
    if (ctx === rootCtx) return void 0;
    const pid = ctx.element?.parentId;
    if (pid === void 0) return rootCtx;
    return containers.get(pid) ?? rootCtx;
  }
  function findPublicExposed(ctx, seg, guard) {
    if (!ctx.element) return void 0;
    const id = ctx.element.id;
    if (guard.has(id)) return void 0;
    guard.add(id);
    try {
      const ownHit = ctx.own.get(seg);
      if (ownHit) return ownHit;
      for (const imp of ctx.imports) {
        if (imp.status !== "resolved" || imp.visibility !== "public" || !imp.resolvedTo) continue;
        if (imp.isWildcard) {
          const tc = ctxOf(imp.resolvedTo);
          if (tc) {
            const found = findPublicExposed(tc, seg, guard);
            if (found) return found;
          }
        } else if (imp.importedName === seg) {
          return imp.resolvedTo;
        }
      }
      return void 0;
    } finally {
  ...
  function publicNames(ctx, guard) {
    if (!ctx.element) return /* @__PURE__ */ new Set();
    const id = ctx.element.id;
    if (guard.has(id)) return /* @__PURE__ */ new Set();
    guard.add(id);
    try {
      const names = new Set(ctx.ownNames);
      for (const imp of ctx.imports) {
        if (imp.status !== "resolved" || imp.visibility !== "public" || !imp.resolvedTo) continue;
        if (imp.isWildcard) {
          const tc = ctxOf(imp.resolvedTo);
          if (tc) {
            for (const n of publicNames(tc, guard)) names.add(n);
          }
  ...
  function searchSegment(start, seg, inProgress) {
    let c = start;
    while (c) {
      const ownHit = c.own.get(seg);
      if (ownHit) return ownHit;
      const viaImport = searchImports(c, seg, inProgress);
      if (viaImport) return viaImport;
      c = parentCtx(c);
    }
    return void 0;
  }
  function searchImports(ctx, seg, inProgress) {
    for (const imp of ctx.imports) {
      if (inProgress.has(imp)) continue;
      resolveImport(imp, inProgress);
      if (imp.status !== "resolved" || !imp.resolvedTo) continue;
      if (imp.isWildcard) {
        const tc = ctxOf(imp.resolvedTo);
        if (tc) {
          const found = findPublicExposed(tc, seg, /* @__PURE__ */ new Set());
          if (found) return found;
        }
      } else if (imp.importedName === seg) {
        return imp.resolvedTo;
  ...
  function resolveImport(imp, inProgress) {
    if (done.has(imp)) return;
    if (inProgress.has(imp)) return;
    inProgress.add(imp);
    const parsed = splitQualified(imp.target);
    const start = parsed.absolute ? rootCtx : (imp.owner !== void 0 ? containers.get(imp.owner) : rootCtx) ?? rootCtx;
    const first2 = searchSegment(start, parsed.segments[0], inProgress);
    if (first2 === void 0) {
      imp.status = libraries.has(parsed.segments[0]) ? "external" : "unresolved";
    } else {
      let el = first2;
      for (const seg of parsed.segments.slice(1)) {
        const c = ctxOf(el);
        if (!c) {
          el = void 0;
          break;
      ...
      if (el !== void 0) {
        imp.status = "resolved";
        imp.resolvedTo = el;
        imp.importedName = parsed.segments[parsed.segments.length - 1];
      } else {
        imp.status = "unresolved";
      }
    }
    inProgress.delete(imp);
    done.add(imp);
  }
  for (const imp of allImports) resolveImport(imp, /* @__PURE__ */ new Set());
  const inputDiags = Array.isArray(
    result.diagnostics
  ) ? result.diagnostics : [];
  const diags = [...inputDiags];
  for (const imp of allImports) {
    if (imp.status === "unresolved") {
      diags.push({
        severity: "warning",
        message: `unresolved import "${imp.target}"` + (imp.owner !== void 0 ? ` in ${imp.owner}` : "")
      });
    }
  }
  const byId = /* @__PURE__ */ new Map();
  for (const [id, ctx] of containers) byId.set(normalizeQualifiedName(id), ctx);
  function descendOwn(el, seg, typeGuard) {
    const c = ctxOf(el);
    if (c) {
      const hit = c.own.get(seg);
      if (hit) return hit;
    }
    const ts = typeListOf(el.member);
    if (ts.length > 0 && !typeGuard.has(el)) {
      typeGuard.add(el);
      try {
        for (const t of ts) {
          const typeEl = resolveNameImpl(t, el.id, typeGuard);
          if (typeEl !== void 0) {
            const tc = ctxOf(typeEl);
            if (tc) {
              const hit = tc.own.get(seg);
              if (hit) return hit;
            }
          }
        }
  ...
  function resolveNameImpl(name, from, typeGuard = /* @__PURE__ */ new Set()) {
    if (typeof name !== "string" || typeof from !== "string" && from !== void 0) {
      return void 0;
    }
    const parsed = splitQualified(name);
    if (parsed.segments.length === 0) return void 0;
    let start = rootCtx;
    if (!parsed.absolute && typeof from === "string" && from.length > 0) {
      const f = byId.get(normalizeQualifiedName(from));
      if (f === void 0) return void 0;
      start = f;
    }
    const first2 = searchSegment(start, parsed.segments[0], /* @__PURE__ */ new Set());
    if (first2 === void 0) return void 0;
    let el = first2;
    for (const seg of parsed.segments.slice(1)) {
      el = descendOwn(el, seg, typeGuard);
  ...
  return {
    ...
    resolveName: resolveNameImpl,
    visibleNames(container) {
      if (typeof container !== "string") return [];
      const ctx = byId.get(normalizeQualifiedName(container));
      if (ctx === void 0) return [];
      const names = [];
      const seen = /* @__PURE__ */ new Set();
      for (const n of ctx.ownNames) {
        names.push(n);
        seen.add(n);
      }
      for (const imp of ctx.imports) {
        ...
        if (imp.isWildcard) {
          const tc = ctxOf(imp.resolvedTo);
          if (tc) {
            for (const n of publicNames(tc, /* @__PURE__ */ new Set())) {
              if (!seen.has(n)) {
                seen.add(n);
                names.push(n);
              }
        ...
        } else if (imp.importedName !== void 0 && !seen.has(imp.importedName)) {
          seen.add(imp.importedName);
          names.push(imp.importedName);
        }
      }
      return names;
    },
